...
const MealPlanPreferences = () => {
    ...
    const renderItem = ({ item }, list, setList) => (
        ...
        >
            <View  style={{backgroundColor:colors.txtColor,height:4,width:4,borderRadius:2}}/>
            <Text style={styles.itemText}>{item.title}</Text>
            <CheckBox
                value={list.includes(item.id)}
                onValueChange={() => toggleSelection(list, setList, item.id)}
    ...
    return (
      ...
      <ScrollView showsVerticalScrollIndicator={false}>
            <Text style={styles.heading}>Meal Plan - Nutrition And Fitness Preferences</Text>

            <Text style={styles.sectionHeader}>What Are Your Main Health And Fitness Goals?</Text>
            <View style={{ backgroundColor:'#C8DBCE',padding:20,
        borderRadius:20}}>
            <FlatList
                data={healthGoals}
            ...
            <Text style={styles.sectionHeader}>How Physically Active Are You On A Typical Day?</Text>
           <View style={{ backgroundColor:'#C8DBCE',padding:20,
        borderRadius:20}}>
            ...
            <Text style={styles.sectionHeader}>Do You Have Any Specific Nutritional Focuses? (Select All That Apply)</Text>
            <View style={{ backgroundColor:'#C8DBCE',padding:20,
        borderRadius:20}}>
            <FlatList
