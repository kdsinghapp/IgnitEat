        ...
        return (
            <View style={styles.container}>
                ...
                <ScrollView showsVerticalScrollIndicator={false}>
                    <Text style={styles.heading}>My personal preferences</Text>
    
    <View style={{flexDirection:'row',alignItems:'center',alignSelf:'center'}}>

<View style={{flexDirection:'row',alignItems:'center'}}>
<Text style={{fontSize:14,color:colors.txtColor,
    marginHorizontal:5,
    fontWeight:'600'}}>Metric</Text>
<CheckBox />
</View>
<View style={{flexDirection:'row',alignItems:'center',marginLeft:20}}>
<Text style={{fontSize:14,    marginHorizontal:5,color:colors.txtColor,fontWeight:'600'}}>Imperial</Text>
<CheckBox />
</View>
    </View>
                    ...
                    <Text style={styles.sectionHeader}>Health-Related Preferences</Text>
                    <View style={styles.listContainer}>
                        <FlatList
                            data={activityLevels}
                    ...
                    <Text style={styles.sectionHeader}>Cultural and Religious Preferences</Text>
                    <View style={styles.listContainer}>
                        <FlatList
                    ...
                    <Text style={styles.sectionHeader}>Allergies and Intolerances</Text>
                    <View style={styles.listContainer}>
                        <FlatList
                            data={nutritionalFocuses}
                            renderItem={(item) => renderItem(item, selectedFocuses, setSelectedFocuses)}
